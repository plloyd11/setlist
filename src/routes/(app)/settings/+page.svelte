...
<div class="mx-auto max-w-2xl p-6 md:p-8">
	...
	<div class="mt-8 space-y-8">
		...
		<section>
			...
			<div class="mt-3 space-y-4 rounded-xl border border-stone-200 bg-white p-4 dark:border-stone-800 dark:bg-stone-900">
				<!-- Display name -->
				<form
					method="POST"
				...
				>
					<label class="block text-sm font-medium text-stone-700 dark:text-stone-300" for="display_name">
						Display name
					</label>
					...
					<div class="mt-2 flex gap-2">
						<input
							...
							class="flex-1 rounded-lg border border-stone-300 bg-transparent px-3 py-2 text-sm text-stone-900 placeholder-stone-400 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500 dark:border-stone-600 dark:text-stone-100 dark:placeholder-stone-500"
						/>
						<button
							type="submit"
							class="rounded-lg bg-amber-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-amber-600 dark:bg-amber-600 dark:hover:bg-amber-500"
						>
