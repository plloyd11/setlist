...
<nav class="fixed bottom-0 left-0 right-0 z-50 flex border-t border-stone-200 bg-white pb-[env(safe-area-inset-bottom)] dark:border-stone-800 dark:bg-stone-900 md:hidden">
